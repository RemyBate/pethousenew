            ...
            <div class="row g-0">
              ...
              <div class="col-md-6 bg-white p-4 p-md-5">
                ...
                <div class="d-grid gap-2">
                  <a href="#" class="btn btn-outline-dark d-flex align-items-center justify-content-center gap-2"><i class="bi bi-apple"></i> Continue with Apple</a>
                  ...
                  <a href="#" class="btn btn-outline-primary d-flex align-items-center justify-content-center gap-2"><i class="bi bi-facebook"></i> Continue with Facebook</a>
                </div>

                <p class="mt-4 mb-0 text-center text-muted">Need an account? <a href="signup.php">Sign up</a></p>
              </div>
            </div>
          </div>
        </div>
